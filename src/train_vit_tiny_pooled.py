...
Backbone: ViT-Tiny (vit_tiny_patch16_224.augreg_in21k_ft_in1k, ImageNet-pretrained)
...
from dataset_pooled import EverydayObjectsDataset
from model_pooled import MultiTaskViT

# -----------------------
# CONFIG
# -----------------------
DATA_ROOT = "data"  # folder containing pooled_images/, processed_dataset.csv, attributes_pooled.yaml
LABELS_CSV_NAME = "processed_dataset.csv"
ATTR_YAML_NAME = "attributes_pooled.yaml"

# ViT-Tiny backbone from timm (ImageNet-21k → 1k finetuned)
...
OUTPUT_DIR = "outputs_vit_tiny_pooled"      # separate from DeiT outputs
