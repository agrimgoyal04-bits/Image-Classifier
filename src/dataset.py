...
class EverydayObjectsDataset(Dataset):
    def __init__(self, root, split, attrs_yaml="attributes.yaml",
                 labels_csv="labels.csv", img_size=224):
        """
        ...
        # Class mapping
        class_labels = sorted({s["class_label"] for s in self.samples})
    ...
    def __getitem__(self, idx):
        ...
        # Class label
        y_class = self.class_to_idx[row["class_label"]]
